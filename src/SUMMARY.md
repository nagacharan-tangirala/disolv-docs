...
- [Software decisions](./decisions/decisions.md)
...
- [Library Crates](./crates/crates.md)
    ...
    - [Network](./crates/network/network.md)
        ...
        - [Slice](./crates/network/slice.md)
        - [Base Station](./crates/network/bs.md)
    - [Input](./crates/input/input.md)
    - [Output](./crates/output/output.md)
